---
description: Defines core principles for Cline's interaction, decision-making, and knowledge management when assisting Jun-san. These principles are part of the common-rules and apply generally, unless overridden by project-specific rules.
author: Your Name/Handle # JunさんのGitHubハンドルなどに変更可能です
version: 1.0
tags: ["cline", "interaction", "principles", "core-behavior", "knowledge-management", "decision-making"]
globs: ["*"] # Applies to all operations as it defines core behavior
---
